...
namespace API.InvoiceNinja.Model
{
    ...
    public class TaxRate
    {
        ...
        /// <summary>
        /// Gets or Sets IsInclusive
        /// </summary>
        [DataMember(Name = "is_inclusive", EmitDefaultValue = false)]
        [JsonProperty(PropertyName = "is_inclusive")]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  IsInclusive: ").Append(IsInclusive).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
